...
import HydraCheck from './HydraCheck';
import { ColumnsType } from 'antd/lib/table';
import { Hydra } from '@/services/Dos/hping3';
import { useModel } from 'umi';
import styles from './index.less';
import Title from 'antd/lib/typography/Title';

const huongdan: string = `Examples:
...
Syntax: hydra [[[-l LOGIN|-L FILE] [-p PASS|-P FILE]] | [-C FILE]]
              ...
              [-f] [-s PORT] [-x MIN:MAX:CHARSET] [-c TIME] [-ISOuvVd46] [-m MODULE_OPT]
...
const HydraGlobal = () => {
  ...
  return (
    <div className={styles.nmapGlobal}>
      ...
      <Spin spinning={hydra.loading}>
        <div className={styles.huongdan}>
          {hydra.data.textarray.length > 0 ? renderPreText(hydra.data.textarray) : (<p>Chưa có kết quả</p>)}
        </div>
      </Spin>
    </div>
  );
